    ...
    <section className="section navy svc-section" id="services">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <p className="section-kicker lead" data-en="We keep offices, commercial areas and warehouses working, remodeled and up to code — with accessible pricing and no shortcuts on quality — plus civil works and specialized telecom tower construction.">Mantenemos oficinas, áreas comerciales y almacenes funcionando, remodelados y en norma — con precios accesibles y sin atajos en calidad — además de obra civil y construcción especializada de torres de telecomunicaciones.</p>
        </div>
        <div className="svc-grid">
          <article className="svc-card is-featured reveal">
            ...
            <h3 data-en="Office, commercial & warehouse remodeling">Remodelación de oficinas, áreas comerciales y almacenes</h3>
            <p data-en="Full redesign of offices, retail spaces and warehouses — partitions, finishes, flooring and lighting, coordinated to minimize disruption to your operation and delivered at an accessible price.">Rediseño integral de oficinas, espacios comerciales y almacenes — divisiones, acabados, pisos e iluminación, coordinados para minimizar la interrupción de su operación y entregados a un precio accesible.</p>
          ...
          <article className="svc-card reveal d2">
            ...
            <p data-en="Turnkey buildings and expansions — from foundations to finishes — for offices, commercial spaces and warehouses, entering any market with the same engineering discipline throughout.">Edificaciones y ampliaciones llave en mano — de la cimentación a los acabados — para oficinas, espacios comerciales y almacenes, entrando en cualquier mercado con la misma disciplina de ingeniería en todo momento.</p>
            <a href="#contact" className="svc-btn" data-en="Read More">
              <span data-en="Read More">Leer más</span>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2}><path d="M5 12h14M13 6l6 6-6 6"/></svg>
            </a>
        ...
        <div className="svc-note reveal d3">
          ...
          <p data-en="We also design, build and update self-supporting telecom towers and monopoles for operators — we have delivered more than 500 towers nationwide through this specialized line of business with its own dedicated clients.">También diseñamos, construimos y actualizamos torres autosoportadas y monopolos de telecomunicaciones para operadores — hemos entregado más de 500 torres a nivel nacional a través de esta línea de negocio especializada con clientes propios.</p>
