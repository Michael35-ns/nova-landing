    ...
    <section className="section" id="stats">
      <div className="wrap">
        <div className="stats-band">
          <div className="stat reveal"><b><span data-count="240">240</span><span className="suf">+</span></b><span data-en="Towers and structures erected">Torres y estructuras erigidas</span></div>
